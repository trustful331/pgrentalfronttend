                  ...
                  <aside className='listings-widget-area'>
                    ...
                    <section className='widget widget_categories'>
                      ...
                      <ul>
                          {/* none hide list */}
                          {
                            ['Restaurant','Hotel','Beauty & Spa','Fitness','Shopping'].map((elm,index)=>(
                                <li>
                          ...
                          {/* hide list */}
                          {
                            ['Hospital','Events','Clothing',].map((elm,index)=>(
                    ...
                    <section className='widget widget_distance'>
                      ...
                      <ul>
                        {/* none hide list */}
                        {
                            ['Driving (5 mi.)','Walking (1 mi.)','Biking (2 mi.)','Within 4 blocks','Bicycle (6 mi.)'].map((elm)=>(
                              <li key={elm}>
                        ...
                        <div className='d-flex justify-content-end'>
                          <div className='select-box'>
                            ...
                            <select className="blog-select">
                              ...
                              {
                                ['Recommended','Default','Latest','Price: low to high','Price: high to low'].map((elm)=>(
                                      ...
                                      <div className='col-lg-8 col-md-8 p-0'>
                                        <div className='listings-content'>
                                          ...
                                          <ul className='listings-meta'>
                                            ...
                                            <li>
                                              <a href='#'>
                                                <i className='flaticon-pin'></i> {obj.address}
                                              </a>
                                            </li>
